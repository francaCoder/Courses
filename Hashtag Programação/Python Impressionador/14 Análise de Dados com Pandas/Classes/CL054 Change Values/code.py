...
new_products_df = pd.read_csv("Contoso - Vendas  - 2017.csv", sep=";")
...
# Change Values → loc & iloc

# new_products_df = new_products_df.set_index("Nome do Produto")
# Now I can find elements by their names

# loc return the values in index 'Number' after each item
print(new_products_df.loc[2])

# or
print(new_products_df.iloc[2, 6])

# Change
new_products_df.loc["Line", "Column"] = "Value"
